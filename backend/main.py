...
async def lifespan(app: FastAPI):
    if settings.PRIMARY_PROVIDER == "groq" and not settings.GROQ_API_KEY:
        raise RuntimeError("DEPLOYMENT SAFETY: PRIMARY_PROVIDER is 'groq' but GROQ_API_KEY is missing.")
